...
bool StringVergleich(String A, String B) { return A.equals(B); }
...
float String_to_float(String s) { return s.toFloat(); }
...
int String_to_int(String S) { return S.toInt(); }
